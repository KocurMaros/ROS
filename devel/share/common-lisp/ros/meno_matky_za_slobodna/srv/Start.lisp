...
(cl:defmethod start-val ((m <Start-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader meno_matky_za_slobodna-srv:start-val is deprecated.  Use meno_matky_za_slobodna-srv:start instead.")
  (start m))
