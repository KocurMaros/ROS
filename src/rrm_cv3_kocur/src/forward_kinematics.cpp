...
void ForwardKinematics::jointCallback(const sensor_msgs::JointState::ConstPtr& msg)
{
    ...
    dh = DH(0,0,0,joint_state_.position[0])*DH(0,90*M_PI/180,L1,joint_state_.position[1])*DH(L2+joint_state_.position[2],0,L2+joint_state_.position[2],0)*DH(0,0,L3,M_PI+joint_state_.position[3]);
    ...
    tf3d_to_joint3.setValue(static_cast<double>(J3(0,0)), static_cast<double>(J3(0,1)), static_cast<double>(J3(0,2)),
                  static_cast<double>(J3(1,0)), static_cast<double>(J3(1,1)), static_c ast<double>(J3(1,2)),
